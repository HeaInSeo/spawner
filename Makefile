...
.PHONY: test coverage coverage-check fmt vet lint lint-depguard lint-fix lint-security lint-security-check vuln vuln-check vuln-all test-race test-lifecycle golangci-lint govulncheck
